...
<div class="container">
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        <div class="card-header">{{ __('Edit Budget Category') }}</div>

        <div class="card-body">
          <form method="POST" action="{{ route('budget_category.update', $budgetCategory->id) }}" novalidate>
            @csrf
            @method('PUT')
            <div class="form-group row">
              ...
              <div class="col-md-6">
                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                  value="{{ old('name') ?? $budgetCategory->name }}" required autofocus>
